    ...
    for (index_k=0; index_k<ppt->k_size[index_md]; index_k++) {
      ...
      if (output_format == class_format) {
        ...
        if (ppt->has_density_transfers == _TRUE_) {
          ...
          class_store_double(dataptr,tk[ppt->index_tp_delta_dtdm],ppt->has_source_delta_dtdm,storeidx);
          class_store_double(dataptr,tk[ppt->index_tp_delta_ddm],ppt->has_source_delta_ddm,storeidx);
        ...
        if (ppt->has_velocity_transfers == _TRUE_) {
          ...
          class_store_double(dataptr,tk[ppt->index_tp_theta_dtdm],ppt->has_source_theta_dtdm,storeidx);
          class_store_double(dataptr,tk[ppt->index_tp_theta_ddm],ppt->has_source_theta_ddm,storeidx);
...
int perturbations_output_titles(
  ...
  if (output_format == class_format) {
    ...
    if (ppt->has_density_transfers == _TRUE_) {
      ...
      class_store_columntitle(titles,"d_dtdm",pba->has_dtdm);
      class_store_columntitle(titles,"d_ddm",pba->has_ddm);
    ...
    if (ppt->has_velocity_transfers == _TRUE_) {
      ...
      class_store_columntitle(titles,"t_dtdm",pba->has_dtdm);
      class_store_columntitle(titles,"t_ddm",pba->has_ddm);
  ...
  for (index_md = 0; index_md < ppt->md_size; index_md++) {
    ...
    if (_scalars_) {
      ...
      if (ppt->has_density_transfers == _TRUE_) {
        ...
        if (pba->has_dtdm == _TRUE_)
          ppt->has_source_delta_dtdm = _TRUE_;
        if (pba->has_fld == _TRUE_)
        ...
        if (pba->has_ddm == _TRUE_)
          ppt->has_source_delta_ddm = _TRUE_;
        if (pba->has_ncdm == _TRUE_)
      ...
      if (ppt->has_velocity_transfers == _TRUE_) {
        ...
        if (pba->has_dtdm == _TRUE_)
          ppt->has_source_theta_dtdm = _TRUE_;
        if (pba->has_fld == _TRUE_)
        ...
        if (pba->has_ddm == _TRUE_)
          ppt->has_source_theta_ddm = _TRUE_;
        if (pba->has_ncdm == _TRUE_)
      ...
      class_define_index(ppt->index_tp_delta_dtdm, ppt->has_source_delta_dtdm,index_type,1);
      ...
      class_define_index(ppt->index_tp_delta_ddm,   ppt->has_source_delta_ddm,  index_type,1);
      ...
      class_define_index(ppt->index_tp_theta_dtdm, ppt->has_source_theta_dtdm,index_type,1);
      ...
      class_define_index(ppt->index_tp_theta_ddm,   ppt->has_source_theta_ddm,  index_type,1);
...
int perturbations_prepare_k_output(struct background * pba,
  ...
  if (ppt->k_output_values_num > 0) {
    ...
    if (ppt->has_scalars == _TRUE_){
      ...
      /* Three Body Decaying cold dark matter */
      class_store_columntitle(ppt->scalar_titles, "delta_dtdm", pba->has_dtdm);
      class_store_columntitle(ppt->scalar_titles, "theta_dtdm", pba->has_dtdm);
      /* Decayed cold dark matter */
      class_store_columntitle(ppt->scalar_titles, "delta_ddm", pba->has_ddm);
      class_store_columntitle(ppt->scalar_titles, "theta_ddm", pba->has_ddm);
      /* Scalar field scf */
...
int perturbations_vector_init(
  ...
  if (_scalars_) {
    ...
    if (pba->has_ddm==_TRUE_){
      class_define_index(ppv->index_pt_delta_ddm,pba->has_ddm,index_pt,1); /* ddm density */
      class_define_index(ppv->index_pt_theta_ddm,pba->has_ddm,index_pt,1); /* ddm velocity */
    }
  ...
  /** - case of switching approximation while a wavenumber is being integrated */
    ...
    if (_scalars_) {
      ...
      if (pba->has_dtdm == _TRUE_) {
        ...
        ppv->y[ppv->index_pt_delta_dtdm] =
          ppw->pv->y[ppw->pv->index_pt_delta_dtdm];

        ppv->y[ppv->index_pt_theta_dtdm] =
          ppw->pv->y[ppw->pv->index_pt_theta_dtdm];
      }
...
int perturbations_initial_conditions(struct precision * ppr,
  ...
  if (_scalars_) {
    ...
    if (pba->has_dtdm == _TRUE_) {
      rho_m += ppw->pvecback[pba->index_bg_rho_dtdm];
    }
    ...
    */
    ...
    if ((ppt->has_ad == _TRUE_) && (index_ic == ppt->index_ic_ad)) {
      ...
      if (pba->has_dtdm == _TRUE_) {
        ppw->pv->y[ppw->pv->index_pt_delta_dtdm] = 3./4.*ppw->pv->y[ppw->pv->index_pt_delta_g]; /* dtdm density */
        /* dcdm velocity velocity vanishes initially in the synchronous gauge */
    ...
    if (ppt->gauge == newtonian) {
      ...
      */
      ...
      if (pba->has_dtdm == _TRUE_){
        delta_cdm += ppw->pvecback[pba->index_bg_rho_dtdm] * ppw->pv->y[ppw->pv->index_pt_delta_dtdm];
        rho_cdm += ppw->pvecback[pba->index_bg_rho_dtdm];
      }
      if (pba->has_ddm == _TRUE_){
        delta_cdm += ppw->pvecback[pba->index_bg_rho_ddm] * ppw->pv->y[ppw->pv->index_pt_delta_ddm];
        rho_cdm += ppw->pvecback[pba->index_bg_rho_ddm];
      }
      ...
      if (pba->has_dtdm == _TRUE_) {
        ppw->pv->y[ppw->pv->index_pt_delta_dtdm] -= (3.*a_prime_over_a + a*pba->Gamma_dtdm)*alpha;
        ppw->pv->y[ppw->pv->index_pt_theta_dtdm] = k*k*alpha;
      }

      if (pba->has_ddm == _TRUE_) {
        ppw->pv->y[ppw->pv->index_pt_delta_ddm] -= (3.*a_prime_over_a - a*pba->Gamma_dtdm*pba->ratioE_dtdm)*alpha;
        ppw->pv->y[ppw->pv->index_pt_theta_ddm] = k*k*alpha;
      }
...
int perturbations_total_stress_energy(
  ...
  if (_scalars_) {
    ...
    if (pba->has_dtdm == _TRUE_) {      
      ...
      ppw->rho_plus_p_tot += ppw->pvecback[pba->index_bg_rho_dtdm];

      if (ppt->has_source_delta_m == _TRUE_) {
        delta_rho_m += ppw->pvecback[pba->index_bg_rho_dtdm]*y[ppw->pv->index_pt_delta_dtdm]; // contribution to delta rho_matter
        rho_m += ppw->pvecback[pba->index_bg_rho_dtdm];
      }
      if ((ppt->has_source_delta_m == _TRUE_) || (ppt->has_source_theta_m == _TRUE_)) {
        rho_plus_p_theta_m += ppw->pvecback[pba->index_bg_rho_dtdm]*y[ppw->pv->index_pt_theta_dtdm]; // contribution to [(rho+p)theta]_matter
        rho_plus_p_m += ppw->pvecback[pba->index_bg_rho_dtdm];
      }
    }
...
int perturbations_sources(
  ...
  if (_scalars_) {
    ...
    /* delta_dtdm */
    if (ppt->has_source_delta_dtdm == _TRUE_) {
      _set_source_(ppt->index_tp_delta_dtdm) = y[ppw->pv->index_pt_delta_dtdm]
        + (3.*a_prime_over_a+a*pba->Gamma_dtdm)*theta_over_k2; // N-body gauge correction;
    }

    /* delta_ddm */
    if (ppt->has_source_delta_dtdm == _TRUE_) {
      _set_source_(ppt->index_tp_delta_ddm) = y[ppw->pv->index_pt_delta_ddm]
        + (3.*a_prime_over_a-a*pba->Gamma_dtdm*pba->ratioE_dtdm)*theta_over_k2; // N-body gauge correction;
    }
    ...
    /* theta_dtdm */
    if (ppt->has_source_theta_dtdm == _TRUE_) {
      _set_source_(ppt->index_tp_theta_dtdm) = y[ppw->pv->index_pt_theta_dtdm]
        + theta_shift; // N-body gauge correction
    }
...
int perturbations_print_variables(double tau,
  ...
  double delta_dtdm=0.,theta_dtdm=0.;
  double delta_ddm=0.,theta_ddm=0.;
  ...
  if (_scalars_) {
    ...
    if (pba->has_dtdm == _TRUE_) {
      ...
      delta_dtdm = y[ppw->pv->index_pt_delta_dtdm];
      theta_dtdm = y[ppw->pv->index_pt_theta_dtdm];

    }

    if (pba->has_ddm == _TRUE_) {

      delta_ddm = y[ppw->pv->index_pt_delta_ddm];
      theta_ddm = y[ppw->pv->index_pt_theta_ddm];
    ...
    if (ppt->gauge == synchronous) {
      ...
      if (pba->has_dtdm == _TRUE_) {
        delta_dtdm += alpha*(-a*pba->Gamma_dtdm-3.*a*H);
        theta_dtdm += k*k*alpha;
      }

      if (pba->has_ddm == _TRUE_) {
        delta_ddm += (-3.*a*H+a*pba->Gamma_dtdm*pba->ratioE_dtdm*pvecback[pba->index_bg_rho_dtdm]/pvecback[pba->index_bg_rho_ddm])*alpha;
        theta_ddm += k*k*alpha;
      }
    ...
    /* Three body decaying cold dark matter */
    class_store_double(dataptr, delta_dtdm, pba->has_dtdm, storeidx);
    class_store_double(dataptr, theta_dtdm, pba->has_dtdm, storeidx);
    /* Decayed cold dark matter */
    class_store_double(dataptr, delta_ddm, pba->has_ddm, storeidx);
    class_store_double(dataptr, theta_ddm, pba->has_ddm, storeidx);
    /* Scalar field scf*/
...
int perturbations_derivs(double tau,
  ...
  if (_scalars_) {
    ...
    if (pba->has_dtdm == _TRUE_) {
      ...
      dy[pv->index_pt_delta_dtdm] = -(y[pv->index_pt_theta_dtdm]+metric_continuity)
        - a * pba->Gamma_dtdm / k2 * metric_euler; /* dtdm density */

      dy[pv->index_pt_theta_dtdm] = - a_prime_over_a*y[pv->index_pt_theta_dtdm] + metric_euler; /* dtdm velocity */
    }
    ...
    if ((pba->has_dtdm == _TRUE_)&&(pba->has_ddm == _TRUE_)) {
      ...
      dy[pv->index_pt_delta_ddm] = -(y[pv->index_pt_theta_dtdm]+metric_continuity)
          + a * pba->Gamma_dtdm * pba->ratioE_dtdm * pvecback[pba->index_bg_rho_dtdm]/pvecback[pba->index_bg_rho_ddm] * (y[pv->index_pt_delta_dtdm] - y[pv->index_pt_delta_ddm] + metric_euler / k2); /* ddm density */
        
      dy[pv->index_pt_theta_ddm] = - y[pv->index_pt_theta_ddm] * (a_prime_over_a + a * pba->Gamma_dtdm * pba->ratioE_dtdm * pvecback[pba->index_bg_rho_dtdm]/pvecback[pba->index_bg_rho_ddm]) + metric_euler; /* ddm velocity */
